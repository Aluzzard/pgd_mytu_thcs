...
//Steering document
Route::get('/chi-tiet-van-ban-chi-dao/{id}',array('as' => 'detailSteeringDocument','uses'=>'Guests\PageController@detailSteeringDocument'))->where(['id'=>'[0-9]+']);
//Image library
Route::get('/thu-vien-anh/{id}','Guests\PageController@imageLibraryDetail');
//Tạo lại mã captcha
Route::get('ajax_regen_captcha', function(){ return captcha_src(); });
//Redirect
Route::get('{slug}', 'Guests\PageController@redirect')->name('home.redirect');
Route::get('{slug}/{slug1}', 'Guests\PageController@detailArticle')->name('home.redirect.detail.article');
?>