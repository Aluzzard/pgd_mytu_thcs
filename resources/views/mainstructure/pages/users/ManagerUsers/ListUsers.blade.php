                        ...
                        <div class="sparkline8-list">
                            ...
                            <div class="sparkline8-graph">
                                ...
                                <div class="text-right">
                                    <button type="button" class="btn btn-sm btn-custon-four btn-success" data-toggle="modal" data-target="#actionModal" onclick="func_buttonClick('add',0)"><i class="fa big-icon fa-plus"></i><span class="ml-2">Thêm người dùng</span></button>
                                </div>
                                @endif
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-action" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Tên người dùng <code>*</code></label>
                        <div class="col-sm-9">
                            <input type="text" id="name" name="name" class="form-control required" data-notify="Vui lòng nhập tên người dùng!" placeholder="Nhập tên người dùng">
                        </div>
                    </div>
                    <div class="form-group row">
