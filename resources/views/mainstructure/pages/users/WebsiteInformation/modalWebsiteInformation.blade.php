            ...
            <div class="modal-body">
                <form id="form-action-information" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Tên doanh nghiệp: <code>*</code></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Mã số doanh nghiệp: </label>
                        <div class="col-sm-10">
                            <input type="text" id="id_input_bussiness_code" name="bussiness_code" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Mẫu giao diện: </label>
                        <div class="col-sm-10">
                    ...
                    <!-- <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Tuỳ biến Footer: </label>
                        <div class="col-sm-10">
                            <textarea id="id_textarea_custom_footer" name="custom_footer" class="form-control" rows="3"></textarea>
                        </div>
                    </div> -->
