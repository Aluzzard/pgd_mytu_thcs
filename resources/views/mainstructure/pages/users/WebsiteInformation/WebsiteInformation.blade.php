                            ...
                            <div class="sparkline13-graph">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-md-8 text-left">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 col-sm-12"><i class="fa fa-star mr-2"></i>Mẫu giao diện: </label>
                                            <span class="col-md-9 col-sm-12" id="span_theme">{{$information_website->theme}}</span>
                                        </div>
                            			<!-- <div class="row">
                            				<label class="col-md-3 col-sm-12"><i class="fa fa-star mr-2"></i>Tuỳ biến Footer: </label>
                            				<span class="col-md-9 col-sm-12" id="span_custom_footer">{!!$information_website->custom_footer!!}</span>
                            			</div> -->
                                	</div>
                                </div>
                            </div>
