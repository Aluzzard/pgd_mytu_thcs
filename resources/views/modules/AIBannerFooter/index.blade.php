                                    ...
                                    <div class="col-lg-12">
                                        <div class="datatable-dashv1-list custom-datatable-overright">
                                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="false" data-show-toggle="true" data-resizable="false" data-cookie="false" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="false">
                                                <thead>
                                                    <tr>
                                                        <th data-field="is_default">Mặc định</th>
            ...
            <div class="modal-body">
                <form id="form-action" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="name" name="name" class="form-control" placeholder="Nhập tên doanh nghiệp">
                        </div>
                    </div>
		                    ...
		                    <div class="row">
		                    	<div class="col-sm-12">
	                        		<div class="form-group row">
	                        			...
	                        			<div class="col-sm-2 d-flex">
                        					<label class="col-form-label pr-3">Mặc định</label>
		                                    <div class="i-checks pull-left">
	                                            <input type="checkbox" name="is_default" value="1"> <i></i>
	                                        </div>
	                        			</div>
	                        			<div class="col-sm-2 d-flex">
                        					<label class="col-form-label pr-3">Loại</label>
...
@endsection
@section('javascript')
    @include('modules.AIBannerFooter.javascripts')
@endsection