...
class UsersController extends Controller {
	public function index(){
		if(CheckRoleByUser::checkRoleFunctionByUser('view', 2) == false){
    		abort('404');
    	} else {
    		$data['html_table'] = $this->htmlDataTable();
    		$data['check_add'] = CheckRoleByUser::checkRoleFunctionByUser('edit', 2);
			return view('mainstructure.pages.users.ManagerUsers.ListUsers', $data);
    	}
	}
	public function ajax(Request $request){
		if(CheckRoleByUser::checkRoleFunctionByUser('view', 2) == true){
	    	...
	    	if ($action_type == 'view' ) {
	    		...
	    		if( CheckRoleByUser::checkRoleFunctionByUser('edit', 2) == true ){
	    		...
	    		if( CheckRoleByUser::checkRoleFunctionByUser('delete', 2) == true ){
	...
	public function htmlDataTable(){
		$accounts_users = (Auth::id() == 1 ? AccountUsers::orderby('active', 'desc')->get() : AccountUsers::where('id','!=', '1')->orderby('active', 'desc')->get());
		$html = '';
		if($accounts_users){
